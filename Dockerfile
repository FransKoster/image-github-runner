...
# Designed for use with Actions Runner Controller on Kubernetes
...
RUN apt-get update -y && apt-get install --no-install-recommends -y curl unzip ca-certificates && update-ca-certificates
